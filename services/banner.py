...
CURRENT_END = {
    "Asia": datetime(2026, 5, 19, 7, 0, tzinfo=timezone.utc),
    "EU": datetime(2026, 5, 19, 14, 0, tzinfo=timezone.utc),
    "NA": datetime(2026, 5, 19, 20, 0, tzinfo=timezone.utc),
}

NEXT_START = {
    "Asia": datetime(2026, 5, 20, 3, 0, tzinfo=timezone.utc),
    "EU": datetime(2026, 5, 20, 3, 0, tzinfo=timezone.utc),
    "NA": datetime(2026, 5, 20, 3, 0, tzinfo=timezone.utc),
}
